...
Soda.prototype.onPlayerJoin = function(player) {
	// body...
};

Soda.prototype.onPlayerLeave = function(player) {
	// body...
};
...
Soda.prototype.getPlayerEntity = function(player) {
...
Soda.prototype.playerActionStart = function(action, player) {
...
Soda.prototype.playerActionStop = function(action, player) {
	switch (this.params.player.actions[action]) {
		case "move":
...
Soda.prototype.keyDown = function(key, player) {
	// body...
};

Soda.prototype.keyUp = function(key, player) {
	// body...
};
...
Soda.prototype.moveEntity = function(direction, entity, enable) {
...
Soda.prototype.jumpEntity = function(entity) {
	entity.jump = this.params.player.jumpPower;
};


Soda.prototype.collision = function(entityA, entityB, data) {
	var tramp = null;
	var entity = null;
...
Soda.prototype.broadcastToWorld = function(type, content) {
	if (this.world) {
		var client;
