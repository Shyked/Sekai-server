...
Player.prototype.goToWorld = function(worldId) {
	...
	if (this.world) {
		...
		var entityJSON = Loader.loadEntitySync(this.world.gamemode.getPlayerEntity(this));
 ...
 *
 * @param entity A copy from the client-side entity
 */
/*Player.prototype.jump = function(entity) {
	if (this.entity) {

		this.player(entity);
		this.entity.jump = this.jumpPower;
