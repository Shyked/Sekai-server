(function() {
	...
	Loader.prototype.loadWorldSync = function(worldName) {
		var data = fs.readFileSync("worlds/" + worldName + ".json");
		if (!data) {
			console.log(err);
			return null;
		}
	...
	Loader.prototype.loadEntitySync = function(entityName) {
		if (!this.loadedEntities[entityName]) this.loadedEntities[entityName] = JSON.parse(fs.readFileSync("entities/" + entityName + ".json"));
