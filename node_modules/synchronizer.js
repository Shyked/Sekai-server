(function() {
	...
	Synchronizer.prototype.initPlayer = function(client) {
		...
		client.data.player.onNicknameOk = function() {
			this.goToWorld(synchronizer.startingWorldId);
			this.client.emit('chatboxMessage', JSON.stringify({
				msg: "",
				nickname: "Welcome in Sekai, " + this.nickname + " !",
				color: {
					r: 60,
					g: 150,
					b: 255
		...
		/*client.emit('askNickname',"");
		client.data.player.goToWorld(this.startingWorldId);*/
	};
